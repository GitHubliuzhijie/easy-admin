...
.v-color-picker-panel {
  width: 230px;
  background: var(--easy-color-bg-container, #ffffff);
  padding: 16px;
  box-shadow:
...
[data-theme='dark'] .v-color-picker-panel {
  box-shadow: none;
  border: var(--easy-border, 1px solid #2c2c2c);
}
...
.v-result {
  color: var(--easy-color-text, #75797e);
  text-align: left;
  flex-grow: 1;
  width: 100%;
  margin-right: 8px;
...
.v-btn-reset {
  background: var(--easy-color-error, #e0e0e0);
  margin-right: 8px;
}
</style>
