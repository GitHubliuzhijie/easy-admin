  ...
  <div class="min-h-screen flex bg-gray-50">
    ...
    <div
      ...
      <div class="absolute inset-0 overflow-hidden">
        <div
            class="absolute top-0 left-0 w-64 h-64 bg-blue-400 rounded-full opacity-20 transform -translate-x-1/2 -translate-y-1/2 animate-pulse"></div>
        <div
            class="absolute bottom-0 right-0 w-80 h-80 bg-indigo-400 rounded-full opacity-20 transform translate-x-1/2 translate-y-1/2 animate-ping"></div>
      ...
      <div class="relative z-10 flex flex-col justify-between h-full">
        <div>
          ...
          <div class="mt-24">
            ...
            <p class="mt-4 text-blue-100 max-w-md">高效、安全、专业的企业级后台管理系统，助力您的业务数字化转型</p>
          </div>
        </div>
    ...
    <div class="w-full md:w-1/2 flex items-center justify-center p-6">
      <div class="w-full max-w-md">
        ...
        <div class="bg-white p-8 rounded-xl shadow-lg">
          ...
          <el-form :model="loginForm" :rules="loginRules" class="mt-8" @submit.prevent="handleLogin">
            <el-form-item>
              <el-input
